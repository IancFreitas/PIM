...
namespace PIM.ListadeEquipamentos
{
    public class BasedeDadosEquips
    {
        public List<Equipamento> EstoqueDeEquipamentos = new List<Equipamento>()
        {
            ...
            new Notebooks.Notebook { Alugado = false, CodigoSerie = 456121, Id = 3, Modelo = "Dell boladao i9", Voltagem = 220 },
            new Tablets.Tablet { Id = 1, Modelo = "Samsung A16", CodigoSerie = 123564, Voltagem = 5, Alugado = false },
            new Tablets.Tablet { Id = 2, Modelo = "Postivo fd5", CodigoSerie = 498498, Voltagem = 5, Alugado = false },
            new Tablets.Tablet { Id = 3, Modelo = "Ipad 10", CodigoSerie = 465186, Voltagem = 5, Alugado = false },
            new Projetores.Projetor { Id = 1, Modelo = "Epson 410", CodigoSerie = 01325546, Voltagem = 220, Alugado = false },
