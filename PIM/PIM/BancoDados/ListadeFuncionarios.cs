...
{
    public static class BasedeDadosFuncionarios
    {
        public static List<Funcionario> CorpoDocente = new List<Funcionario>()
        {
            ...
            new Funcionarios.Funcionario {Nome="Clayton", Cpf=11987654321, CodigoFuncionario=201, Id=21, Funcao="Professor", CodigoFuncao=2, Usuario="Clayfessor",Senha="senha789"},
            new Funcionarios.Funcionario {Nome="Fernanda", Cpf=45678912322, CodigoFuncionario=202, Id=22, Funcao="Professor", CodigoFuncao=2, Usuario="Iandev",Senha="senha123"}
        };
